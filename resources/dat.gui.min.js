			...
			var n = void 0,
				o = {
					...
					rgb_to_hsv: function (e, t, n) {
						...
						return 0 === i
							? { h: NaN, s: 0, v: 0 }
							: ((l = r / i), (a = e === i ? (t - n) / r : t === i ? 2 + (n - e) / r : 4 + (e - t) / r), (a /= 6), a < 0 && (a += 1), { h: 360 * a, s: l, v: i / 255 });
					},
				...
				c = (function (e) {
					...
					return (
						...
						(t.prototype.updateDisplay = function () {
							return (
								this.getValue() === !0 ? (this.__checkbox.setAttribute("checked", "checked"), (this.__checkbox.checked = !0)) : (this.__checkbox.checked = !1), e.prototype.updateDisplay.call(this)
							);
						}),
						t
					);
